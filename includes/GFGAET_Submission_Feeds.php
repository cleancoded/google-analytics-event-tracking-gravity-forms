...
class GAETGF_Submission_Feeds extends GFFeedAddOn {
	...
	private function load_ua_settings() {
		...
		$this->ua_id = $ua_id = GAETGF::get_ua_code();
	...
	private function push_event( $entry, $form, $ga_event_data ) {
		...
		*/
		...
		$event = new GAETGF_Measurement_Protocol();
		$event->init();
